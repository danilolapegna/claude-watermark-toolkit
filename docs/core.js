  ...
  const PRECISION_COPY = {
    ...
    it: {
      ...
      method: [
        ...
        "Evita lucidatura generica, formalità gonfiata e riempitivi che l'autore non userebbe.",
      ],
      ...
      audit: [
        ...
        "Verifica che il risultato sembri ancora scritto dallo stesso autore per lo stesso lettore.",
      ],
